        ...
        <div className="bg-neutral-100 rounded-2xl px-6 py-2">
            <Card title="Identifying Unexpected Behaviour">
                <p className="text-lg text-neutral-700 mb-4">
                    ...
                    Each day, I would run the app to see if there was unexpected behaviour. There were many issues with the app at 
                    first. It was quite intimidating to see basically a hundred lines of error messages. Overtime, I became adept
                    at <NavLink to="/how-to-read-errors" className="text-blue-600 hover:underline">reading errors</NavLink>.
                </p>
                <p className="text-lg text-neutral-700 mb-4">
